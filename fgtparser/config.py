...
class FgtConfigDict(dict[str, FgtConfigNode]):
    ...
    def skeys(self) -> list[str]:
        ...
        This method returns the keys of the dictionary in a list, sorted
        alphabetically without regard to case (i.e., using ``str.lower`` as the
        sort key).

        :returns: A list of all dictionary keys, sorted case-insensitively.
        """
...
class FgtConfigBody(FgtConfigNode, FgtConfigDict, ABC):
    ...
    def walk(self, key: str, delimiter: str = "/") -> Iterator[FgtConfigItem]:
        ...
        Nodes of types ``FgtConfigObject`` and ``FgtConfigTable`` are traversed
        recursively. Nodes of types ``FgtConfigSet`` and ``FgtConfigUnset`` are
        considered leaves and yielded directly. Any other node type raises a
        ``TypeError``.
...
class FgtConfigObject(FgtConfigBody):
    ...
    def c_table(self,
        ...
        :param default: A fallback value to return if the key is not found.
            Defaults to ``None``.
        :returns: The configuration table associated with the key.
    ...
    def c_set(self,
        ...
        :param default: A fallback value to return if the key is not found.
            Defaults to ``None``.
        :returns: The configuration set associated with the key.
        :raises KeyError: If the key is not found and no default is provided.
        :raises TypeError: If the retrieved value is not of type
            ``FgtConfigSet``.
        """
    ...
    def opt(self,
        ...
        :returns: The value of the parameter or the ``default`` value if the
    ...
    def same(self,
        ...
        :param default: A fallback value to return if the parameter is not
            found. Defaults to ``None``.
        :returns: ``True`` if the parameter value matches the provided
...
class FgtConfigSet(FgtConfigNode):
    ...
    def __getitem__(self, index: int) -> FgtConfigToken:
        ...
        This method allows you to access a specific parameter in the SET
        command by providing its index. The parameters are stored in an
        ordered collection.

        :param index: The index of the parameter to retrieve.
        :returns: The token at the specified index in the parameter list.
    ...
    def __setitem__(self, index: int, value: Any) -> None:
        ...
        This method allows you to modify a parameter in the SET command by
        providing the index and the new value for that parameter.
    ...
    def __repr__(self) -> str:
        ...
        This method provides a concise string representation of the SET command,
        showing the list of parameters contained within it.

        :returns: A string representing the list of parameters in the SET
            command.
        """
    ...
    def __len__(self) -> int:
        ...
        This method returns the total count of parameters present in the SET
        command.

        :returns: The number of parameters in the SET command.
        """
    ...
    def params(self) -> FgtConfigTokens:
        ...
        This property provides direct access to the parameters stored in the SET
        command.

        :returns: The collection of tokens (parameters) associated with the SET
            command.
        """
...
class FgtConfigRoot(FgtConfigObject):
    ...
    def sections(self,
        ...
        The method will yield each section as a tuple of the section's key and
        its corresponding value. If a ``partial_key`` is provided, it filters
        sections whose keys match the ``partial_key``'s prefix.
...
class FgtConfig(object):
    ...
    def make_config(self,
        ...
        :returns: A list of strings representing the configuration.
        """
